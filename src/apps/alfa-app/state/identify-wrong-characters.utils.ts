/* ------------------------------------------------------------------
 *  identify-wrong-characters.utils.ts
 * ------------------------------------------------------------------ */
 ...
 *  PUBLIC EXPORT                                                   *
 *───────────────────────────────────────────────────────────────────*/
export const identifyWrongCharacters = (args: IdentifyArgs) =>
  IdentifyWrongChars.identifyWrongCharacters(args);
